...
<html xmlns:jsp="http://java.sun.com/JSP/Page"
    ...
    <head>
        ...
        <!-- Magnific Popup -->
        <link rel="stylesheet" href="http://localhost:8080/css/magnific-popup.min.css">
        <!-- Font Awesome -->
        <link rel="stylesheet" href="http://localhost:8080/css/font-awesome.css">
        <!-- Fancybox -->
        <link rel="stylesheet" href="http://localhost:8080/css/jquery.fancybox.min.css">
        <!-- Themify Icons -->
        <link rel="stylesheet" href="http://localhost:8080/css/themify-icons.css">
        <!-- Nice Select CSS -->
        <link rel="stylesheet" href="http://localhost:8080/css/niceselect.css">
        <!-- Animate CSS -->
        <link rel="stylesheet" href="http://localhost:8080/css/animate.css">
        <!-- Flex Slider CSS -->
        <link rel="stylesheet" href="http://localhost:8080/css/flex-slider.min.css">
        <!-- Owl Carousel -->
        <link rel="stylesheet" href="http://localhost:8080/css/owl-carousel.css">
        <!-- Slicknav -->
